...
/**
 * Application Information configuration properties definition
 *
...
public class ApplicationInformationProperties {
     ...
     */
    public ApplicationInformationProperties(boolean devMode, String name, int port,
                                            String instanceId, String instanceGroup, List<String> tags) {
        Preconditions.checkNotNull(name, "[app.name] must not be null");
