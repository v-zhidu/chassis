package io.vzhidu.chassis.common.core.iso;
...
/**
 * Country Code based on <a href="https://en.wikipedia.org/wiki/ISO_3166-1">ISO-3166-1</a>
 * <p>
 * Note: This enum copied from Github for avoid add a dependency. Only include the necessary functions.
 * https://github.com/TakahikoKawasaki/nv-i18n/blob/master/src/main/java/com/neovisionaries/i18n/CountryCode.java
 *
 * @author Zhiqiang Du Created at 2020/4/8
 */
public enum CountryCode {
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/South_Georgia_and_the_South_Sandwich_Islands">
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/Saint_Helena,_Ascension_and_Tristan_da_Cunha">Saint Helena, Ascension and
     * Tristan da Cunha</a>
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/United_States_Minor_Outlying_Islands">
    ...
    private static final Map<String, CountryCode> ALPHA3_MAP = new HashMap<>();
    private static final Map<Integer, CountryCode> NUMERIC_MAP = new HashMap<>();

    static {
        for (CountryCode cc : values()) {
            if (Objects.nonNull(cc.getAlpha3())) {
                ALPHA3_MAP.put(cc.getAlpha3(), cc);
            }

            if (cc.getNumeric() != CountryCode.UNDEFINED.getNumeric()) {
                NUMERIC_MAP.put(cc.getNumeric(), cc);
            }
        }

        // BU and MM have the same numeric code 104. MM should be used.
        NUMERIC_MAP.put(104, MM);

        // CD and ZR have the same numeric code 180. CD should be used.
        NUMERIC_MAP.put(180, CD);

        // FI and SF have the same numeric code 246. FI should be used.
        NUMERIC_MAP.put(246, FI);

        // GB and UK have the same numeric code 826. GB should be used.
        NUMERIC_MAP.put(826, GB);

        // TL and TP have the same numeric code 626. TL should be used.
        NUMERIC_MAP.put(626, TL);
    }
     ...
     * @param numeric integer value of country code
     */
    ...
    /**
     * Get the code based on ISO 3166-1 alpha2 code
     *
     * @return the code based on ISO 3166-1 alpha2 code
     */
    ...
    /**
     * Get the code based on ISO 3166-1 alpha3 code
     *
     * @return the code based on ISO 3166-1 alpha3 code
     */
    ...
    /**
     * Get the {@link CountryCode} with the given string
     *
    ...
    /**
     * Get the {@link CountryCode} with the given string, not case-sensitive
     *
     * @param code the string code
     * @return {@link CountryCode}
     */
    ...
    public static CountryCode getByCode(String code, boolean caseSensitive) {
        ...
        switch (code.length()) {
            case 2:
                countryCode = getByAlpha2Code(code);
                break;
            case 3:
                countryCode = getByAlpha3Code(code);
                break;
            default:
    ...
    private static String canonicalize(String code, boolean caseSensitive) {
        ...
        return caseSensitive ? code : code.trim().toUpperCase();
    }

    /**
     * Get the {@link CountryCode} with the given alpha2 code
     *
     * @param code the string code
     * @return {@link CountryCode}
     */
    ...
    /**
     * Get the {@link CountryCode} with the given alpha3 code
     *
     * @param code the string code
     * @return {@link CountryCode}
     */
    public static CountryCode getByAlpha3Code(String code) {
        return ALPHA3_MAP.get(code);
    }

    /**
     * Get the {@link CountryCode} with the given numeric code
     *
     * @param numeric the numeric code
     * @return {@link CountryCode}
     */
    public static CountryCode getByNumeric(int numeric) {
