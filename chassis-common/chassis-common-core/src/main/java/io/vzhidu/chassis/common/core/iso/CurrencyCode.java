...
/**
 * Currency Code based on <a href="https://en.wikipedia.org/wiki/ISO_4217">ISO-4217</a>
 * <p>
 * Note: This enum copied from Github for avoid add a dependency. Only include the necessary functions.
 * https://github.com/TakahikoKawasaki/nv-i18n/blob/master/src/main/java/com/neovisionaries/i18n/CurrencyCode.java
 *
...
public enum CurrencyCode {
    ...
    private static final Map<Integer, CurrencyCode> NUMERIC_MAP = new HashMap<>();
    ...
    /**
     * Get the numeric code with a given currency
     *
    ...
    /**
     * Get a {@code CurrencyCode} that corresponds to the given ISO 4217 alpha-3 code.
     *
     * @param code string of code name
    ...
    /**
     * Get a {@code CurrencyCode} that corresponds to the given ISO 4217 alpha-3 code.
     * Ignore the case of code string.
     *
     * @param code string of code name
     * @return @{code CurrencyCode}
     */
     ...
     *
     * @param code          string of code name
     * @param caseSensitive if true, code is case-sensitive
     * @return @{code CurrencyCode}
     */
    ...
    /**
     * Get a {@code CurrencyCode} that corresponds to the given numeric code.
     *
     * @param numeric the numeric value.
     * @return {@code CurrencyCode#UNDEFINED} if numeric less than 0
     */
    public static CurrencyCode getByCode(int numeric) {
        if (numeric <= 0) {
            return CurrencyCode.UNDEFINED;
        }
    ...
    /**
     * Get a list of {@code CurrencyCode} instances whose country list contains the specified country
     *
     * @param country code name of {@link CountryCode}
     * @return list of currencies used by the country
     */
    ...
    public static List<CurrencyCode> getByCountry(CountryCode country) {
        ...
        if (Objects.isNull(country) || country == CountryCode.UNDEFINED) {
            return list;
        }
