...
public abstract class ClientException extends RuntimeException {
     ...
     */
    public ClientException(String message, RpcStatus rpcStatus, HttpStatus httpStatus) {
        super(message);
     ...
     * @since 1.4
     */
    public ClientException(String message, Throwable cause, RpcStatus rpcStatus, HttpStatus httpStatus) {
        super(message, cause);
        this.rpcStatus = rpcStatus;
        this.httpStatus = httpStatus;
    }
